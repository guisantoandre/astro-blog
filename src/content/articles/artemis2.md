...
A missão também representa um salto tecnológico. Pela primeira vez, comunicações a laser permitem transmissão de dados em alta velocidade, incluindo vídeos em alta resolução diretamente do espaço profundo :contentReference[oaicite:2]{index=2}.
...
## O caminho de volta à Lua

A Artemis II é apenas um passo dentro de um plano maior. Ela prepara o terreno para futuras missões que pretendem levar humanos novamente à superfície lunar e estabelecer presença sustentável por lá :contentReference[oaicite:3]{index=3}.
